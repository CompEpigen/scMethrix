...
While the formats are compatible, some analysis tools in `Seurat` are not compatible with methylation data. The structure of  methylation data is similar enough that visualization and summarization tools will likely work, but any type of mapping, ontology, or feature analysis will likely give incorrect results.
