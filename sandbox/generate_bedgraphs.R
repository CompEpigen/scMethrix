...
numfiles = 5      # Number of files to generate
numrows = 1000     # Max number of CpG sites in sample
chrs = 10          # Number of chromosomes
minsparsity = 0.5     # Minimum sparsity (minrows = numrows*sparsity)
maxsparsity = 0.8 # Max sparsity
rangeFactor = 1   # Max range of IRange (1:rangeFactor*numrows)
