...
generic_scMethrix_function <- function(scm, assay, new_assay, regions, trans, phenotype, verbose, n_chunks, n_threads, h5_dir, overlap_type, batch_size, replace, na.rm) {}
