...
#' @details The dimensionality reduction algorithms used do not allow for `NA` values, so the input matrix will likely need to be imputed or binned, among others. 
#' 
...
#' @inheritParams generic_scMethrix_function
#' @return [scMethrix] object with new `reducedDim` element
