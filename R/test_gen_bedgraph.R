...
#TODO: Getting overlapping regions at the boundaries of chromosomes. Use the simple below until fixed
...
numfiles <- 100
numrows <- 1000000
chrs <- 1 # must be factor of numrows
rangeFactor <- 100 # max value is rangeFactor*numrows
